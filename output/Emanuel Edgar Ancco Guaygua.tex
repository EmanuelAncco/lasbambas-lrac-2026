...
\midrule
\textbf{A1} & Repositorio público en GitHub & Código Python reproducible del análisis estadístico, scripts de visualización, documentación arquitectónica de los 12 workflows GAIATECH M1.0 y plantilla LaTeX del informe. Licencia MIT, integración continua con GitHub Actions. \newline \url{https://github.com/emanuelancco/lasbambas-lrac-2026} \\
