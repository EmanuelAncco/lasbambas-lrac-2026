...
\textbf{A5} & Archivo Power BI \texttt{.pbix} & Modelo tabular completo del Excel del caso con medidas DAX (Pilar L\,/\,R\,/\,A\,/\,C, LRAC--4P, Score compuesto $\mu-\sigma$), visuales matriz, heatmap, evolución mensual y slicers. Tema visual MMG (rojo \texttt{\#C8102E}). Archivo adjunto al envío y enlazado en Drive público. \\
\bottomrule
\end{tabularx}
