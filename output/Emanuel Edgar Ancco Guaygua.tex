...
\item \textbf{M1.B · Aecodito Minero} habilita \emph{A-01} (medición 3Q VP SHE), \emph{A-02} (Tarjeta Verde digital), \emph{A-08} (cápsula semanal con quiz), \emph{A-10} (onboarding asistido), \emph{A-11} (plataforma RACS conversacional, Figura \ref{fig:whatsapp}) y \emph{A-17} (BBS dirigido).
...
\captionof{figure}{Workflow LRAC-001 · captura RACS conversacional vía Aecodito Minero.}
\label{fig:whatsapp}
\end{minipage}
\vspace{6pt}
...
\textbf{A3} & Video 90 s GAIATECH M1.0 & Demostración audiovisual del bot Aecodito Minero capturando un RACS en vivo (texto, foto y voz), detección EPP YOLOv8 continua y dashboard ejecutivo Vision Pro PDK. Voz Gemini TTS Kore. Subido a YouTube unlisted; URL incluida en el correo de envío. \\
