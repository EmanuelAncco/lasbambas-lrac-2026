...
\item \textbf{M1.B · TOKI} habilita \emph{A-01} (medición 3Q VP SHE en tiempo real), \emph{A-02} (Tarjeta Verde digital), \emph{A-08} (cápsula semanal con quiz), \emph{A-10} (onboarding asistido), \emph{A-11} (plataforma RACS conversacional) y \emph{A-17} (BBS dirigido peer-to-peer).
...
\textbf{A3} & Video 90s GAIATECH M1.0 & Demostración del bot TOKI capturando un RACS en vivo (texto + foto + voz), detección EPP YOLOv8 sobre cámara y dashboard ejecutivo Vision Pro PDK con alertas. Subido a YouTube unlisted. \emph{URL pendiente.} \\
...
\item A3 (video) muestra simultáneamente M1.A (visión EPP), M1.B (TOKI) y M1.D (dashboard).
